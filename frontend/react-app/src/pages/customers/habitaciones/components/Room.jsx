...
let includes;
    ...
    case "economica":
      includes =  <><Row className="justify-content-center">
         <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/piscina-white.png" width="35rem" className="me-4" />
            <h4 className="mt-2"><b>Acceso a Piscina</b></h4>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/desayuno-white.png" width="35rem" className="me-4" />
            <h4 className="mt-2"><b>Desayuno Incluído</b></h4>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/wifi-white.png" width="35rem" className="me-4" />
    ...
    case "plus":
      includes = <><Row className="justify-content-center">
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/piscina.png" width="35rem" className="me-4" />
            <h4 className="mt-2"><b>Acceso a Piscina</b></h4>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/desayuno.png" width="35rem" className="me-4" />
            <h4 className="mt-2"><b>Desayuno Incluído</b></h4>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/wifi.png" width="35rem" className="me-4" />
            <h4 className="mt-2"><b>Wifi Gratuíto</b></h4>
          </Col>
        </Row>
        <><Row className="justify-content-center mt-2">
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/habitacionAmplia.png" width="35rem" className="me-4"/>
            <h4 className="mt-2"><b>Habitación Amplia</b></h4>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/lavanderia.png" width="35rem" className="me-4"/>
            <h4 className="mt-2"><b>Lavandería</b></h4>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <img src="src/assets/icons/minibar.png" width="35rem" className="me-4"/>
