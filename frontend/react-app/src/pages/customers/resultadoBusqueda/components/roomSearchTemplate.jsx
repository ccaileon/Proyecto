...
import "./roomSearchTemplate.css";

function RoomSearchTemplate({ precio, capacidad, imagenUrl, tipo }) {
  let includes;
  let titulo;
  ...
  switch (tipo) {
    ...
    case "standard-family":
      titulo = "Habitación Familiar Estándar";
      break;
    case "plus":
      titulo = "Habitación Brisa";
      break;
    case "plus-family":
      titulo = "Habitación Familiar Brisa";
      break;
    case "suite":
...
export default RoomSearchTemplate;
